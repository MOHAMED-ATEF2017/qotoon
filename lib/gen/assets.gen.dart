...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/calendersvg.svg
  SvgGenImage get calendersvg =>
      const SvgGenImage('assets/icons/calendersvg.svg');
  ...
  /// File path: assets/icons/livivngroom.svg
  SvgGenImage get livivngroom =>
      const SvgGenImage('assets/icons/livivngroom.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/offertrans.png
  AssetGenImage get offertrans =>
      const AssetGenImage('assets/images/offertrans.png');

  /// File path: assets/images/reversation.png
  AssetGenImage get reversation =>
      const AssetGenImage('assets/images/reversation.png');

  /// File path: assets/images/splash.jpg
  AssetGenImage get splash => const AssetGenImage('assets/images/splash.jpg');

  /// File path: assets/images/x4.png
  AssetGenImage get x4 => const AssetGenImage('assets/images/x4.png');

  /// File path: assets/images/x5.png
  AssetGenImage get x5 => const AssetGenImage('assets/images/x5.png');

  /// List of all assets
  List<AssetGenImage> get values =>
      [logo, map, offer, offertrans, reversation, splash, x4, x5];
}

class $AssetsLottiesGen {
  const $AssetsLottiesGen();

  /// File path: assets/lotties/qotoon.json
  LottieGenImage get qotoon =>
      const LottieGenImage('assets/lotties/qotoon.json');

  /// List of all assets
  List<LottieGenImage> get values => [qotoon];
}
